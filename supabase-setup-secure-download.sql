-- ==============================================
-- SECURE DOWNLOAD SYSTEM - SUPABASE SETUP
-- ==============================================
-- Kjør denne SQL-en i Supabase SQL Editor

-- 1. Opprett secure_download_tokens tabell
...
-- 2. Opprett download_logs tabell
...
-- 9. Gi tilgang til funksjoner (juster basert på din setup)
...
-- 10. Test funksjonen (valgfritt - fjern etter testing)
